...
export async function generateAnswer(
  ...
  const prompt = `
    ...
    INSTRUÇÕES:
    - Use apenas inforamações contidas no contexto para responder a pergunta;
    - Se a resposta não for encontrada no contexto ou for imprecisa, responda com "Nao sei";
    - Seja objetivo;
  ...
  if (!response.text) {
    throw new Error('Nao foi possivel gerar a resposta');
  }
